from sqlalchemy import Column, String, Text, DateTime, Float, JSON, Boolean, ForeignKey, Integer
...
class Mission(Base):
    ...
    http_exchanges = relationship("HttpExchange", back_populates="mission", cascade="all, delete-orphan")
...
class HttpExchange(Base):
    ...
    mission = relationship("Mission", back_populates="http_exchanges")
