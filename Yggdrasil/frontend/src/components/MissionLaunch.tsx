    ...
    <main style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 2rem' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ fontSize: '0.8rem', color: 'var(--text-dim)', lineHeight: 1.8 }}>
          Authorized targets only. Define scope, select assessment mode, and Yggdrasil agents run in sequence.
        </p>
      </div>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        {scopeTab === 'upload' && (
          <div>
            ...
            >
              <div style={{ fontSize: '0.8rem', marginBottom: '0.5rem', color: 'var(--accent)' }}>CSV</div>
      ...
      {error && <div style={{ fontSize: '0.8rem', color: 'var(--accent2)', marginBottom: '1rem' }}>Error: {error}</div>}
